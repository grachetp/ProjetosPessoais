 ...
 * @author Marcelo
 */
public class TelaLogarConta extends javax.swing.JFrame {
    /**
     * Creates new form Base
     */
    public TelaLogarConta() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/visa-card.png"))); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(pswdSenha, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE)
    ...
    private void btnEntrarContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarContaActionPerformed
        // TODO add your handling code here:
        //Verificando se o campos estão vazios ou nulos
        if(txtNumConta.getText() == null || txtNumConta.getText().trim().isEmpty() ||
           pswdSenha.getText() == null || pswdSenha.getText().trim().isEmpty())
        {
            JOptionPane.showMessageDialog(null, "Preencha Corretamente todos os campos", "Campos vazios ou nulos", 0);
        }
        else{
            int num_conta = Integer.parseInt(txtNumConta.getText());
            int senha = Integer.parseInt(pswdSenha.getText());
            
            Conta conta = new Conta();
            
            conta = ContaDAO.buscarConta(num_conta);
            
            if(conta == null){
                JOptionPane.showMessageDialog(null, "Conta não encontrada!");
                txtNumConta.setText(null);
            }else{
                if(conta.getSenha() == senha){
                    this.dispose();
                    TelaPainelConta telaPainelConta = new TelaPainelConta(conta);
                    telaPainelConta.setVisible(true);
                }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLogarConta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLogarConta().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JFormattedTextField txtNumConta;
